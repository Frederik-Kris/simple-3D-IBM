function l2err = laplace(N, BCTypeOuter, BCTypeInner, sigma, Tinner, Touter, qNeumann, doPlot)
...
diamcylInner = 3.5;          % Diameter of cylinder
diamcylOuter = 8.5;          % Diameter of cylinder
...
lx   = 10;              % Length of computational domain in x direction
ly   = 10;              % Length of computational domain in y direction
xcentroidcyl = lx/2;    % x position of centroid cylinder
ycentroidcyl = ly/2;    % y position of centroid cylinder
