function [l2err, temp] = laplace_copy(N, BCTypeOuter, BCTypeInner, sigma, Tinner, Touter, qNeumann, doPlot)
...
diamcylInner = 2*0.2;          % Diameter of cylinder
diamcylOuter = 2*0.45;          % Diameter of cylinder
...
xcentroidcyl = 0.5;    % x position of centroid cylinder
ycentroidcyl = 0.5;    % y position of centroid cylinder
